...
func (c *Config) Load() error {
	...
	c.checkAssetBuckets()
	c.checkIDs("blacklist", c.Blacklist, false)
	c.checkIDs("people", c.People, true)
	c.checkIDs("excluded_people", c.ExcludedPeople, false)
	c.checkIDs("albums", c.Albums, true)
	c.checkIDs("excluded_albums", c.ExcludedAlbums, false)
	c.checkIDs("excluded_partners", c.ExcludedPartners, false)
	c.checkAlbumOrder()
