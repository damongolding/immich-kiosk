...
type Config struct {
	...
	ShowVideosPercent bool `json:"showVideosPercent" yaml:"show_videos_percent" mapstructure:"show_videos_percent" query:"show_videos_percent" form:"show_videos_percent" default:"0.1"`
