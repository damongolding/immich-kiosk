...
| use_original_image                | KIOSK_USE_ORIGINAL_IMAGE | bool                      | false       | Use the original image. NOTE: This will cause errors if your orignal images are not in web formats (gif, webp, png, jpg ect) such as heic or raw formats. |
