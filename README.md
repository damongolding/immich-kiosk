...
services:
  immich-kiosk:
    ...
    environment:
      ...
      KIOSK_PORT: 3000
      KIOSK_IMMICH_USERS_API_KEYS: "{\"user1\":\"****\"}"
...
| immich_users_api_keys                       | KIOSK_IMMICH_USERS_API_KEYS                | map[string]string          | ""          | The API key for each user for your Immich server. See [multiple users](#multiple-users) for more information |
