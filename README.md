...
| person            | KIOSK_PERSON            | []string                   | The ID(s) of a specific person or people you want to display. Having the album set will overwrite this. See [FAQs](#faq) to see how to impliment this.|
