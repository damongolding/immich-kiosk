...
func ImageLocation(hideCountries []string, info immich.ExifInfo) string {
	...
	if info.Country != "" && !slices.Contains(hideCountries, info.Country) {
...
func imageMetadata(viewData ViewData, imageIndex int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if viewData.ShowImageLocation {
			...
			templ_7745c5c3_Err = templ.Raw(ImageLocation(viewData.HideCountries, viewData.Images[imageIndex].ImmichImage.ExifInfo)).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div>")
...
func layoutSplitView(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for imageIndex, imageData := range viewData.Images {
			var templ_7745c5c3_Var21 = []any{fmt.Sprintf("frame--layout-%s", viewData.Layout)}
			...
			var templ_7745c5c3_Var24 = []any{"frame--image", templ.KV("frame--image-zoom", viewData.ImageZoom), animationDuration(viewData.Refresh), zoomInOrOut()}
