...
// KioskComponentConfig defines configuration for a kiosk component
type KioskComponentConfig struct {
	Version   string          // Version of the kiosk
	DeviceID  string          // Unique identifier for the device
	Duration  float32         // Duration for transitions
	SwapStyle string          // Style for content swapping
	ExtraCSS  templ.Component // Additional CSS to include
}
...
// kioskBase creates the base kiosk component with configuration
func kioskBase(config KioskComponentConfig) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		ctx = templ.ClearChildren(ctx)
		if config.ExtraCSS != nil {
			templ_7745c5c3_Err = config.ExtraCSS.Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf(`{"kiosk-version": "%s", "kiosk-device-id": "%s"}`, config.Version, config.DeviceID))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 48, Col: 111}
		}
		...
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(config.SwapStyle)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 49, Col: 28}
		}
...
// kioskNone creates the kiosk component with no transition effects
func kioskNone(kioskVersion string, deviceID string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = kioskBase(KioskComponentConfig{
...
// kioskFade creates the kiosk component with the fade transition
func kioskFade(kioskVersion string, deviceID string, fadeDuration float32) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = kioskBase(KioskComponentConfig{
			...
			SwapStyle: fmt.Sprintf("innerHTML swap:%.1fs", fadeDuration/2),
			ExtraCSS:  templ.Raw(fadeDurationCSS(fadeDuration / 2)),
		}).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
// kioskCrossFade creates the kiosk component with the cross-fade transition
func kioskCrossFade(kioskVersion string, deviceID string, crossFadeDuration float32) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = kioskBase(KioskComponentConfig{
			...
			SwapStyle: fmt.Sprintf("beforeend settle:%.1fs", crossFadeDuration+1),
			ExtraCSS:  templ.Raw(crossFadeDurationCSS(crossFadeDuration)),
		}).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
// baseFontSize sets the base font size as a CSS property
...
// baseFontSizeMobile generates CSS for mobile font sizing
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for key, values := range queries {
			for _, value := range values {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 254, Col: 55}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 254, Col: 71}
				}
...
func clockHtmx(theme string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var15 = []any{fmt.Sprintf("clock--theme-%s", theme)}
...
func weatherHtmx(theme string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var18 = []any{fmt.Sprintf("weather--theme-%s", theme)}
...
func refreshCheckForm(kioskVersion, reloadTimeStamp string, queries url.Values) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var23, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf(`{"kiosk-version": "%s", "kiosk-reload-timestamp":"%s"}`, kioskVersion, reloadTimeStamp))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 311, Col: 115}
		}
...
func Home(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var25 = []any{baseFontSize(viewData.FontSize)}
		...
		templ_7745c5c3_Var27, templ_7745c5c3_Err = templ.JoinStringErrs(viewData.KioskVersion)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 322, Col: 55}
		}
		...
		templ_7745c5c3_Var28, templ_7745c5c3_Err = templ.JoinStringErrs(string(templ.URL(fmt.Sprintf("/assets/css/kiosk.%s.css", viewData.KioskVersion))))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 330, Col: 114}
		}
		...
		var templ_7745c5c3_Var29 = []any{fmt.Sprintf("layout-%s", viewData.Layout)}
		...
		templ_7745c5c3_Var31, templ_7745c5c3_Err = templ.JoinStringErrs(string(templ.URL(fmt.Sprintf("/assets/js/kiosk.%s.js", viewData.KioskVersion))))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_home.templ`, Line: 406, Col: 96}
		}
